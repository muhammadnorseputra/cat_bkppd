				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="input-group">
							...
							data-validation-error-msg-container="p.help-block-nik" data-validation-error-msg-required="Nomor peserta wajib diisi"data-validation-error-msg-length="Nilai input minimal 8 angka" data-validation-error-msg-number="Jenis format hanya boleh angka" 
							type="text" id="noktp" name="noktp" placeholder="No Registrasi Peseta" class="form-control"/>
						</div> <!-- /password -->
					...
					<div class="col-md-6">			
						...
						<span class="text-mutted">Masukan nomor hp yang aktif. Kami akan mengirimkan sms / telpon jika anda terpilih sebagai pemenang.</span><br>
						...
						<div class="input-group">
							...
							<p class="help-block-nohp text-right"></p>
...
<script type="text/javascript">
	...
	$("select[name='provinsi']").on('change', function() {
		...
		$.get('<?php echo base_url("adm/list_kabupaten") ?>', {id: this.value}, function(result) {
			...
			$('body').loading({
				message: 'Mencari Kabupaten / Kota ...',
			});
		}).done(() => {
			$('body').loading('stop');
		});		
    ...
    onSuccess : function($form) {
      ...
      $.ajax({
      	...
      	beforeSend: function() {
      		$('body').loading({
      			message: 'Mendaftarkan Mohon Tunggu ...',
      			theme: 'dark'
      		});
      	},
      	dataType: 'json',
