...
function gen_menu() {
	...
	$CI->load->model('monitoring');
	$ur = $CI->monitoring->get_item_mapel();
	$menu = array();
	...
	if ($sess_level == "guru") {
	  ...
	  $menu = array(
	            array("icon"=>"dashboard", "url"=>"", "text"=>"Dashboard"),
	            array("icon"=>"list-alt", "url"=>"m_siswa", "text"=>"Data Perserta"),
	            array("icon"=>"list-alt", "url"=>"m_guru", "text"=>"Data Penguji"),
	            array("icon"=>"list-alt", "url"=>"m_mapel", "text"=>"Data Mata Ujian"),
	            array("icon"=>"list-alt", "url"=>"m_soal", "text"=>"Soal"),
	            array("icon"=>"file", "url"=>"h_ujian", "text"=>"Hasil Ujian"),
	          );
	} else if ($sess_level == "monitor") {
	  $menu = array(
	            array("icon"=>"dashboard", "url"=>"", "text"=>"Dashboard"),
	            array("icon"=>"print", "url"=>"monitor_hasil/".$ur, "text"=>"Monitor Ujian"),
	          );
	} else if ($sess_level == "registrasi") {
	  $menu = array(
	            array("icon"=>"dashboard", "url"=>"", "text"=>"Dashboard"),
	            array("icon"=>"list-alt", "url"=>"m_siswa", "text"=>"Data Perserta")
	          );
